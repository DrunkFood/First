...
GlobalExceptionHandler_core --> BusinessException : "捕获"
GlobalExceptionHandler_core --> AuthException : "捕获"
GlobalExceptionHandler_ai --> AiUnavailableException : "捕获"
GlobalExceptionHandler_ai --> BusinessException : "捕获"
GlobalExceptionHandler_ai --> AuthException : "捕获"
GlobalExceptionHandler_file --> FileException : "捕获"
GlobalExceptionHandler_file --> BusinessException : "捕获"
GlobalExceptionHandler_file --> AuthException : "捕获"
GlobalExceptionHandler_support --> BusinessException : "捕获"
GlobalExceptionHandler_support --> AuthException : "捕获"
```
...
- [GlobalExceptionHandler (file).java:21-64](file://ele-ai-tender-system/ele-ai-tender-file/src/main/java/com/jy/eleaitender/file/handler/GlobalExceptionHandler.java#L21-L64)
- [GlobalExceptionHandler (support).java:28-95](file://ele-ai-tender-system/ele-ai-tender-support/src/main/java/com/jy/eleaitender/support/handler/GlobalExceptionHandler.java#L28-L95)
- [HttpRequestLogFilter.java:41-106](file://ele-ai-tender-system/ele-ai-tender-common/src/main/java/com/jy/eleaitender/common/logging/HttpRequestLogFilter.java#L41-L106)
