...
class DetectionServiceImplTest {
    ...
    void submitUsesBusinessContentInsteadOfGeneratedDocumentFile() {
        ...
        when(aiTaskService.createInternalTask(any(AiTaskType.class), anyLong(), anyLong(), anyString(),
        ...
        verify(aiTaskService, times(3)).createInternalTask(taskTypeCaptor.capture(), anyLong(), anyLong(), anyString(),
    ...
    void submitIncludesPolicyReviewWhenPolicyFilesSelected() {
        ...
        verify(aiTaskService, times(4)).createInternalTask(taskTypeCaptor.capture(), anyLong(), anyLong(), anyString(),
