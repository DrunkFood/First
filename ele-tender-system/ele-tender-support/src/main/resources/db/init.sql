...
(3, '创建用户', 'user:create', 2, NULL, 'user:create', 1, 1, NOW(), NOW()),
(3, '编辑用户', 'user:update', 2, NULL, 'user:update', 2, 1, NOW(), NOW()),
(3, '删除用户', 'user:delete', 2, NULL, 'user:delete', 3, 1, NOW(), NOW()),
(3, '启用/禁用', 'user:status', 2, NULL, 'user:status', 4, 1, NOW(), NOW()),
(3, '重置密码', 'user:reset-password', 2, NULL, 'user:reset-password', 5, 1, NOW(), NOW()),

-- 角色管理
(1, '角色管理', 'role', 1, '/system/role', 'role:view', 2, 1, NOW(), NOW()),
(9, '创建角色', 'role:create', 2, NULL, 'role:create', 1, 1, NOW(), NOW()),
(9, '编辑角色', 'role:update', 2, NULL, 'role:update', 2, 1, NOW(), NOW()),
(9, '删除角色', 'role:delete', 2, NULL, 'role:delete', 3, 1, NOW(), NOW()),
(9, '分配权限', 'role:assign-permission', 2, NULL, 'role:assign-permission', 4, 1, NOW(), NOW()),

-- 菜单管理
(1, '菜单管理', 'menu', 1, '/system/menu', 'menu:view', 3, 1, NOW(), NOW()),
(14, '创建菜单', 'menu:create', 2, NULL, 'menu:create', 1, 1, NOW(), NOW()),
(14, '编辑菜单', 'menu:update', 2, NULL, 'menu:update', 2, 1, NOW(), NOW()),
(14, '删除菜单', 'menu:delete', 2, NULL, 'menu:delete', 3, 1, NOW(), NOW()),

-- 接入系统管理
(1, '接入系统', 'access-system', 1, '/system/access-system', 'system:view', 4, 1, NOW(), NOW()),
(18, '创建系统', 'system:create', 2, NULL, 'system:create', 1, 1, NOW(), NOW()),
(18, '编辑系统', 'system:update', 2, NULL, 'system:update', 2, 1, NOW(), NOW()),
(18, '删除系统', 'system:delete', 2, NULL, 'system:delete', 3, 1, NOW(), NOW()),
(18, '启用/禁用', 'system:status', 2, NULL, 'system:status', 4, 1, NOW(), NOW()),
(18, '重新生成密钥', 'system:regenerate-secret', 2, NULL, 'system:regenerate-secret', 5, 1, NOW(), NOW()),
...
(25, '创建版本', 'main-version:create', 2, NULL, 'main-version:create', 1, 1, NOW(), NOW()),
(25, '编辑版本', 'main-version:update', 2, NULL, 'main-version:update', 2, 1, NOW(), NOW()),
(25, '删除版本', 'main-version:delete', 2, NULL, 'main-version:delete', 3, 1, NOW(), NOW()),
(25, '发布版本', 'main-version:publish', 2, NULL, 'main-version:publish', 4, 1, NOW(), NOW()),
(25, '下线版本', 'main-version:offline', 2, NULL, 'main-version:offline', 5, 1, NOW(), NOW()),

-- 插件版本管理
(2, '插件版本', 'plugin-version', 1, '/version/plugin', 'plugin-version:view', 2, 1, NOW(), NOW()),
(31, '创建插件', 'plugin-version:create', 2, NULL, 'plugin-version:create', 1, 1, NOW(), NOW()),
(31, '编辑插件', 'plugin-version:update', 2, NULL, 'plugin-version:update', 2, 1, NOW(), NOW()),
(31, '删除插件', 'plugin-version:delete', 2, NULL, 'plugin-version:delete', 3, 1, NOW(), NOW()),
(31, '发布插件', 'plugin-version:publish', 2, NULL, 'plugin-version:publish', 4, 1, NOW(), NOW()),
(31, '下线插件', 'plugin-version:offline', 2, NULL, 'plugin-version:offline', 5, 1, NOW(), NOW());
